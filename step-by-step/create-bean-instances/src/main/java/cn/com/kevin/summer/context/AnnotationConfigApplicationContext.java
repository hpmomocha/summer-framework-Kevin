...
import cn.com.kevin.summer.annotation.*;
import cn.com.kevin.summer.exception.BeanCreationException;
import cn.com.kevin.summer.exception.BeanDefinitionException;
import cn.com.kevin.summer.exception.BeanNotOfRequiredTypeException;
import cn.com.kevin.summer.exception.NoUniqueBeanDefinitionException;
import cn.com.kevin.summer.io.PropertyResolver;
import cn.com.kevin.summer.io.ResourceResolver;
...
public class AnnotationConfigApplicationContext {
    ...
    Map<String, BeanDefinition> createBeanDefinitions(Set<String> beanClassNames) {
        ...
        for(String beanClassName: beanClassNames) {
            ...
            if (component != null) {
                ...
                var def = new BeanDefinition(beanName, clazz, getSuitableConstructor(clazz),
                        getOrder(clazz), clazz.isAnnotationPresent(Primary.class),
                        null, null, // init/destroy方法名称:
                        ClassUtils.findAnnotationMethod(clazz, PostConstruct.class), // 查找@PostConstruct方法:
                        ClassUtils.findAnnotationMethod(clazz, PreDestroy.class)); // 查找@PreDestroy方法:
        ...
        for (Method method: clazz.getDeclaredMethods()) {
            if (method.isAnnotationPresent(Bean.class)) {
                ...
                var def = new BeanDefinition(ClassUtils.getBeanName(method), beanClass, factoryBeanName, method, getOrder(method),
                        ...
                        bean.initMethod().isEmpty() ? null : bean.initMethod(), // init method:
                        bean.destroyMethod().isEmpty() ? null : bean.destroyMethod(), // destroy method:
    ...
    protected Set<String> scanForClassNames(Class<?> configClass) {
        ...
        String[] scanPackages = componentScan.value() == null || componentScan.value().length == 0 ?
